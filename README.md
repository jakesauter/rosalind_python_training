...
[**Counting Expected Offspring**](http://rosalind.info/problems/iev/solutions/) -- [counting_expected_offspring.py](files/counting_expected_offspring.py) -- a short and simple program but features the smart use of mapping the list of number of genotype parents to a list of probabilities of those parents having a phenotype dominant child using the **zip** function
